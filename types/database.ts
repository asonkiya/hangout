  ...
  public: {
    Tables: {
      ...
      venue_candidates: {
        ...
        Insert: OptionalFields<Omit<VenueCandidateRow, 'id' | 'created_at'>, 'price_level' | 'rating' | 'category' | 'source' | 'eta_seconds' | 'photo_urls' | 'address' | 'website_url' | 'maps_url' | 'user_rating_count' | 'is_open' | 'suggested_by_user_id'>;
